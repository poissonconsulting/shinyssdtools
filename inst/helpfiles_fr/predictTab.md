...
1. Deux options sont possibles : 
    - Estimer la **concentration** affectant/protégeant une **fraction sélectionnée d'espèces (%)** - - Estimer la fraction d'espèces (%) affectée par une concentration sélectionnée.
