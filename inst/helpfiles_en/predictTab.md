...
1. There are two options: 
    - Estimate the **Concentration** affecting/protecting a selected fraction of species (%) 
    - Estimate the **fraction of species (%)** affected by a selected concentration. 
    
    This affects the plot (dotted line), text displayed below the plot and calculations of confidence limits.
